            ...
            <div class="divide-y divide-gray-200">
                ...
                <div class="p-6 bg-blue-50 hover:bg-blue-100 transition cursor-pointer">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-700 ml-8">Un livreur a envoyé une offre pour votre commande #001
                            </p>
                            <p class="text-xs text-gray-500 mt-2 ml-8">Il y a 5 minutes</p>
                        </div>
                        <a href="commande-detail.html?id=1" class="text-indigo-600 hover:text-indigo-800 text-sm">
                ...
                <div class="p-6 hover:bg-gray-50 transition cursor-pointer">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-700 ml-8">Votre commande #002 est maintenant en cours de
                                traitement</p>
                            <p class="text-xs text-gray-500 mt-2 ml-8">Il y a 1 heure</p>
                        </div>
                        <a href="commande-detail.html?id=2" class="text-indigo-600 hover:text-indigo-800 text-sm">
                            Voir <i class="fas fa-arrow-right ml-1"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="p-6 hover:bg-gray-50 transition cursor-pointer">
                    <div class="flex items-start justify-between">
                        ...
                        <a href="commande-detail.html?id=3" class="text-indigo-600 hover:text-indigo-800 text-sm">
                            Voir <i class="fas fa-arrow-right ml-1"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="p-6 hover:bg-gray-50 transition cursor-pointer">
                    <div class="flex items-start justify-between">
                        ...
                        <a href="commande-detail.html?id=4" class="text-indigo-600 hover:text-indigo-800 text-sm">
                            Voir <i class="fas fa-arrow-right ml-1"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="p-6 hover:bg-gray-50 transition cursor-pointer">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-700 ml-8">Un livreur a envoyé une offre pour votre commande #005
                            </p>
                            <p class="text-xs text-gray-500 mt-2 ml-8">Il y a 2 jours</p>
                        </div>
                        <a href="commande-detail.html?id=5" class="text-indigo-600 hover:text-indigo-800 text-sm">
                            Voir <i class="fas fa-arrow-right ml-1"></i>
                        </a>
                    </div>
                </div>
